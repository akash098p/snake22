...
![Serpent1](images/snake1.png)

![Serpent2](images/snake2.png)
...
- 🎨 Advanced UI/UX for a browser game  
- 🧩 Modular game logic (Snake, Food, PowerUp classes)  
